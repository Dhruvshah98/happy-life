...
// wp_enqueue_style('swiper-css', 'https://cdnjs.cloudflare.com/ajax/libs/Swiper/8.4.5/swiper-bundle.css',false,'1.1','all' );
// wp_enqueue_style('select2-css', 'https://cdn.jsdelivr.net/npm/swiper@8/swiper-bundle.min.css',false,'1.1','all' );
// wp_enqueue_style('magnific-popup-css', get_template_directory_uri() . '/assets/css/magnific-popup.css',false,'1.1','all' );
...
function blankslate_footer() {
    ...
    if(is_page_template('landing.php')){
	    ...
	    wp_enqueue_script( 'index',  get_template_directory_uri() . '/assets/js/home.js', array (), 1.1, true);
		// wp_enqueue_script( 'home-anim',  get_template_directory_uri() . '/assets/js/home-anim.js', array (), 1.1, true);
    ...
    //     wp_enqueue_style('magnific-css', 'https://cdnjs.cloudflare.com/ajax/libs/magnific-popup.js/1.1.0/magnific-popup.min.css',false,'1.1','all' );
        
	// 	wp_enqueue_script( 'magnific', 'https://cdnjs.cloudflare.com/ajax/libs/magnific-popup.js/1.1.0/jquery.magnific-popup.min.js', array (), 1.1, true);
	// 	wp_enqueue_script( 'team',  get_template_directory_uri() . '/assets/js/team.js', array (), 1.1, true);
